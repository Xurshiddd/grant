...
<body class="min-h-screen flex items-center justify-center p-4 login-container">
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden login-box flex max-w-4xl w-full">
        ...
        <div class="logo-section bg-blue-600 flex flex-col items-center justify-center p-8 text-white md:w-1/2">
            ...
            <p class="text-blue-100 text-center">Toshkent To'qimachilik va yengil sanoat instituti talabalari uchun ta'lim grantiga ariza topshirish uchun platforma</p>
            <div class="mt-8">
        ...
        <div class="p-8 md:w-1/2 flex flex-col justify-center">
            ...
            <!-- Staff Login Form -->
            <form id="staff-login" action="{{ route('login') }}" method="post" class="space-y-4">
                @csrf
                <div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="#" class="text-sm text-blue-600 hover:text-blue-800">Parolni unutdingizmi?</a>
                </div>
            ...
            <form id="student-login" action="{{ route('login') }}" method="post" class="space-y-4 hidden">
                @csrf
                <div>
                    <label for="passport" class="block text-sm font-medium text-gray-700 mb-1">Passport raqami</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <i class="fas fa-id-card text-gray-400"></i>
                        </div>
                        <input type="text" id="passport" name="passport" class="w-full pl-10 pr-4 py-2 border rounded-lg input-field focus:outline-none focus:border-blue-500" placeholder="AA1234567" required>
                    </div>
                </div>
                
                <div>
                    <label for="student-password" class="block text-sm font-medium text-gray-700 mb-1">Parol</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <i class="fas fa-lock text-gray-400"></i>
                        </div>
                        <input type="password" id="student-password" name="password" class="w-full pl-10 pr-4 py-2 border rounded-lg input-field focus:outline-none focus:border-blue-500" placeholder="********" required>
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer" onclick="togglePasswordVisibility('student-password')">
                            <i class="fas fa-eye text-gray-400 hover:text-blue-500"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input id="remember-student" type="checkbox" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        <label for="remember-student" class="ml-2 block text-sm text-gray-700">Eslab qolish</label>
                    </div>
                    <a href="#" class="text-sm text-blue-600 hover:text-blue-800">Parolni unutdingizmi?</a>
                </div>
    ...
    <script>
        // Toggle between staff and student login
        ...
        //     e.preventDefault();
        //     alert('Xodimlar uchun kirish formasi yuborildi!');
        //     // Here you would typically handle the login logic
        // });
        
        // studentForm.addEventListener('submit', function(e) {
        //     e.preventDefault();
        //     alert('Talabalar uchun kirish formasi yuborildi!');
        //     // Here you would typically handle the login logic
        // });
    </script>
</body>
